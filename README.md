...
### a.	讀取帳戶、交易紀錄：備份人員可以把整個資料庫的使用者資料備份，以防資料庫崩潰，導致資料損毀。
### b.	讀取使用者回報的錯誤、建議：可以讀取這些建議跟回報，以防還沒處理就毀損。
### c.	讀取分類、每日預算、儲蓄目標資料表：可以讀取這些分類、每日預算、儲蓄目標資料，以防毀損。
### d.	讀取目前已封鎖帳號：以防資料遺失封鎖帳號就不見。
...
(12, 5, '買顯卡', 99000, 6000, '2025-06-11', '2026-06-11', 'Active'),
...
(5, 2, 'Suggestion', '分類刪除應同步處理', '刪除分類應連動刪除相關預算資料，否則容易有落差', '2025-06-03 12:12:01'),
(6, 1, 'Suggestion', '希望能整合記帳功能', '有時需要記錄額外費用，希望能有更彈性記帳功能', '2025-06-03 12:12:01'),
(7, 1, 'Bug', '新增交易無法儲存', '新增交易點擊儲存後無反應', '2025-06-03 12:12:01'),
(8, 4, 'Suggestion', '資料匯出功能建議', '建議能匯出 CSV 或 Excel 的功能，方便備份', '2025-06-03 12:12:01'),
(9, 4, 'Bug', '提醒功能無作用', '設定提醒並無正常跳出提醒通知', '2025-06-03 12:12:01'),
(10, 1, 'Suggestion', '希望支援深色模式', '希望實現 dark mode，對於夜間使用者更友善', '2025-06-03 12:12:01');
```
...
(9, 5, 'BB12365487', 500, '2025-06-12', NULL, NULL, 56, 'Pending'),
(23, 31, 'A12345678', 1000, '2025-06-14', '早餐殿', '88888888', 122, 'Pending'),
